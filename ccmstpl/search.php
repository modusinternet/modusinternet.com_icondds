...
{CCMS_TPL:footer-js.html}
			...
			/*
			Argument details for build_css_link() and build_js_link() function calls:
			...
			*/
			...
			function loadJSResources(){
				loadFirst("{CCMS_LIB:site.php;FUNC:build_js_link("","","MODERNIZER")}",function(){

					loadFirst("{CCMS_LIB:site.php;FUNC:build_js_link("","","JQUERY")}",function(){

						loadFirst("{CCMS_LIB:site.php;FUNC:build_js_link("","","JQUERY-MOBILE-CUST")}",function(){

							loadFirst("{CCMS_LIB:site.php;FUNC:build_js_link("","","JQUERY-VALIDATE")}",function(){

								loadFirst("{CCMS_LIB:site.php;FUNC:build_js_link("","","JQUERY-VALIDATE-ADDITIONAL-METHODS")}",function(){
									...
									}{CCMS_LIB:site.php;FUNC:build_js_sri("","JS-01")});
								}{CCMS_LIB:site.php;FUNC:build_js_sri("","JQUERY-VALIDATE-ADDITIONAL-METHODS")});
							}{CCMS_LIB:site.php;FUNC:build_js_sri("","JQUERY-VALIDATE")});
						}{CCMS_LIB:site.php;FUNC:build_js_sri("","JQUERY-MOBILE-CUST")});
					}{CCMS_LIB:site.php;FUNC:build_js_sri("","JQUERY")});
				}{CCMS_LIB:site.php;FUNC:build_js_sri("","MODERNIZER")});
			}
